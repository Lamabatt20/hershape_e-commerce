...
const Checkout = () => {
  ...
  const handlePlaceOrder = async () => {
    ...
    if (!validate()) {
      setMessage(language === "ar" ? "يرجى تعبئة جميع الحقول المطلوبة بشكل صحيح" : "Please fill all required fields correctly");
      return;
    }
        ...
        <div className="checkout-form">
          ...
          <div className="form-section">
            ...
            <div className="row">
              <label>
                ...
                <input type="text" value={firstName} onChange={(e) => setFirstName(e.target.value)} className={errors.firstName ? "error-input" : ""} />
              </label>
              <label>
                <span>{language === "ar" ? "اسم العائلة" : "Last Name"}<span className="required"></span></span>
                <input type="text" value={lastName} onChange={(e) => setLastName(e.target.value)} className={errors.lastName ? "error-input" : ""} />
              </label>
            </div>
            <label>
            ...
            <label>
              ...
              <input type="tel" value={phone} onChange={(e) => setPhone(e.target.value)} className={errors.phone ? "error-input" : ""} />
            </label>
          </div>
          ...
          <div className="form-section">
            ...
            <label>
              ...
              <input type="text" value={street} onChange={(e) => setStreet(e.target.value)} className={errors.street ? "error-input" : ""} />
            </label>
            <div className="row">
              <label>
                <span>{language === "ar" ? "المدينة" : "City"}<span className="required"></span></span>
                <input type="text" value={city} onChange={(e) => setCity(e.target.value)} className={errors.city ? "error-input" : ""} />
              </label>
              <label>
