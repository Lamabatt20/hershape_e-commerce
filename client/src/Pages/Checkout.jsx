...
const Checkout = () => {
  ...
  useEffect(() => {
    ...
    const inside48Cities = [
      ...
      "الرملة","ramla","الناصرة","nazareth","شفاعمرو","shefa-'amr",

      "أم الفحم","umm al-fahm","سخنين","sakhnin","الطيبة","tayibe","رهط","rahat"
    ...
    <>
      ...
      <div className="checkout-container" dir={language === "ar" ? "rtl" : "ltr"}>
        ...
        <div className="checkout-form">
          ...
          <button onClick={handlePlaceOrder} disabled={loading} className="complete-order-btn">
